...
function declare_dynamic_shovel
{
    ...
    curl -vu guest:guest -H 'content-type: application/json' \
        ...
        --data-binary "{\"component\":\"shovel\",\"vhost\":\"/\",\"name\":\"$dynamic_shovel_name\",\"value\":{\"src-uri\":[\"amqp://localhost:5672/%2F\",\"amqp://localhost:5673/%2F\",\"amqp://localhost:5674/%2F\"],\"src-queue\":\"$src_queue\",\"src-protocol\":\"amqp091\",\"src-prefetch-count\":1000,\"src-delete-after\":\"queue-length\",\"dest-protocol\":\"amqp091\",\"dest-uri\":[\"amqp://localhost:5672/%2F\",\"amqp://localhost:5673/%2F\",\"amqp://localhost:5674/%2F\"],\"dest-add-forward-headers\":false,\"ack-mode\":\"on-confirm\",\"dest-queue\":\"$dest_queue\"}}"
}
